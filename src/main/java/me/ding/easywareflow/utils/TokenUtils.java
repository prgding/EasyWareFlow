...
import me.ding.easywareflow.exception.BusinessException;
...
public class TokenUtils {
    ...
    public String loginSign(CurrentUser currentUser, String password) {
        ...
        stringRedisTemplate.opsForValue().set(token, token, expireTime * 2L, TimeUnit.HOURS);
        return token;
    }
    ...
    public CurrentUser getCurrentUser(String token) {
        ...
        if (ObjectUtils.isEmpty(userCode) || ObjectUtils.isEmpty(userName)) {
